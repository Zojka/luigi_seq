...
sample_chipseq_gm12878 = {}
input_gm12878 = {}
# names of samples between input, hichip and ChIP-seq have to match
samples = sample_arima_hichip
samples_chip = sample_chipseq_gm12878
# leave input None if you don't want to use it
sample_input = {"sample": }
